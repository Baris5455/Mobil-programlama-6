...
class CustomTextField extends StatelessWidget {
  ...
  String? _validateName(String? value) {  // İsim doğrulama işlevi
    if (value == null || value.isEmpty) {
      return 'İsim boş olamaz';
    }
    return null;
  }
  String? _validateEmail(String? value) { // E-mail doğrulama işlevi
    if (value == null || value.isEmpty) {
  ...
  String? _validatePassword(String? value) {  // Şifre doğrulama işlemi
    if (value == null || value.isEmpty) {
